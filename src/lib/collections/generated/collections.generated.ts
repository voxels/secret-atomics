...
// Generated at: 2026-02-15T21:31:23.849Z
...
export const DEFAULT_COLLECTION_SLUGS: Record<CollectionType, string> = {
  "collection.article": "past-work",
  "collection.documentation": "about",
...
export const SLUG_TO_TYPE_MAP: Record<string, Record<string, CollectionType>> = {
  "en": {
    "past-work": "collection.article",
    "about": "collection.documentation",
...
export const GENERATION_METADATA = {
  generatedAt: '2026-02-15T21:31:23.849Z',
  locales: ["en"],
