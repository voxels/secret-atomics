  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_end: cn(
          'isolate -z-0 relative rounded-r-(--cell-radius) bg-muted after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-muted',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'relative isolate z-10 flex aspect-square size-auto min-w-(--cell-size) w-full flex-col gap-1 border-0 font-normal leading-none',
